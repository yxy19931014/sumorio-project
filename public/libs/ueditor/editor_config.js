...
(function () {
    ...
    //var URL= tmp.substr(0,tmp.lastIndexOf("\/")+1).replace("_examples/","");//这里你可以配置成ueditor目录在您网站的相对路径或者绝对路径（指以http开头的绝对路径）
    UEDITOR_CONFIG = {
        ...
        toolbars:[
            ['FullScreen', 'Undo', 'Redo', '|',
                ...
                '|',
                'Link', 'Unlink',  'InsertImage', 'HighlightCode', '|',
                'Horizontal', 
                'InsertTable']
        ],
        ...
        //提交表单时，服务器获取编辑器提交内容的所用的参数，多实例时可以给容器name属性，会将name给定的值做为每个实例的键值，不用每次实例化的时候都设置这个值
        textarea:'content',
        ...
        highlightJsUrl: "/libs/SyntaxHighlighter/shCore.js",
        highlightCssUrl: "/libs/SyntaxHighlighter/shCoreDefault.css",
